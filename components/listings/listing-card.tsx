  ...
  return (
    <div className="group relative">
      <Link
        ...
        className="flex flex-col overflow-hidden rounded-2xl border-2 border-border bg-card shadow-brutal-sm transition-all hover:-translate-y-1 hover:shadow-brutal"
      >
